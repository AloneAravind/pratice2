...
# 2)d="{[((()))}]}}" pass the string is valid otherwise it cannot close the brackets inproperly correct that will be invalid
...
d = "{[((()))}]}}"
print(is_valid_bracket_sequence(d))  # This should print False
